...
def main():
    ...
    if data_sources:
        ...
        if not combined_data.empty:
            ...
            percent_changes = combined_data.apply(calculate_daily_percent_change)
            
            correlation_matrix = percent_changes.corr(method='pearson')
            ...
            spy_stats = percent_changes['SPY'].describe()
            print(spy_stats)

            # Calculate std off of daily percent change from the maximum
            ...
            print("\nStandard Deviation of Daily Percent Change from Maximum:")
