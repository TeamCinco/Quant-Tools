...
def plot_trendline_and_std_ranges(hist, mean_aroc, std_deviation, mean_price, std_prices, ticker):
    ...
    plt.savefig(r'C:\Users\cinco\Desktop\DATA FOR SCRIPTS\Results\9.21.24\{ticker}_Price_STD.png')
...
def plot_performance_with_aroc_std(hist, mean_aroc, std_deviation, ticker):
    ...
    plt.savefig(r'C:\Users\cinco\Desktop\DATA FOR SCRIPTS\Results\9.21.24\{ticker}_performance_aroc_std_chart.png')
...
def main():
    ...
    # Save to Excel
    excel_filename = r"C:\Users\cinco\Desktop\DATA FOR SCRIPTS\Results\9.21.24\LargeCap_Analysis.xlsx"
