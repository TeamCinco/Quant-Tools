...
def plot_trendline_and_std_ranges(hist, mean_aroc, std_deviation, mean_price, std_prices, ticker):
    ...
    plt.savefig(f'/Users/jazzhashzzz/Desktop/data for scripts/results/screener/9.28.24/{ticker}_Price_STD.png')
...
def plot_performance_with_aroc_std(hist, mean_aroc, std_deviation, ticker):
    ...
    plt.savefig(f'/Users/jazzhashzzz/Desktop/data for scripts/results/screener/9.28.24/{ticker}_performance_aroc_std_chart.png')
...
def main():
    ...
    # Save to Excel
    excel_filename = f"/Users/jazzhashzzz/Desktop/data for scripts/results/screener/9.28.24/{size_filter}_Cap_Analysis.xlsx"
    ...
    def plot_aroc_bell_curve(aroc_list, log_aroc_list):
        ...
        plt.tight_layout()
        output_dir = "/Users/jazzhashzzz/Desktop/data for scripts/results/screener/9.28.24"
        os.makedirs(output_dir, exist_ok=True)  # This will create the directory if it doesn't exist

        path = rf"{output_dir}/{size_filter}_aroc_bell_curves.png"
        plt.savefig(path)
