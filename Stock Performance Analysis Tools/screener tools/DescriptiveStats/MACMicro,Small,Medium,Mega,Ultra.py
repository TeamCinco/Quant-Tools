...
def filter_by_market_cap(ticker, size):
    ...
    if size == 'micro' and market_cap < 3e8:
        return True
    elif size == 'small' and 3e8 <= market_cap < 2e9:
        return True
    elif size == 'mid' and 2e9 <= market_cap < 10e9:
        return True
    elif size == 'large' and 10e9 <= market_cap < 50e9:
        return True
    elif size == 'mega' and 50e9 <= market_cap < 200e9:
        return True
    elif size == 'ultra' and market_cap >= 200e9:
        return True
    else:
        return False
