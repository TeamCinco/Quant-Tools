...
def main():
    ...
    with ThreadPoolExecutor(max_workers=10) as executor:
        futures = {executor.submit(process_ticker, ticker, cik, size_filter): ticker for ticker, cik in tickers.items()}
    ...
    results_df.to_csv('/Users/jazzhashzzz/Desktop/Quant-Tools/Stock Performance Analysis Tools/screener tools/stock_std_analysis.csv', index=False)
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('/Users/jazzhashzzz/Desktop/Quant-Tools/Stock Performance Analysis Tools/screener tools/aroc_distribution.png')
