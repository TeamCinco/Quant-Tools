...
# Modified logic for daily percent change
data['Open to Close %'] = ((data['Close'] - data['Open']) / data['Open']) * 100
data['Open to High %'] = ((data['High'] - data['Open']) / data['Open']) * 100
data['High to Open %'] = ((data['Open'] - data['High']) / data['High']) * 100
data['Daily Change %'] = (data['Open to Close %'] + data['Open to High %'] + data['High to Open %']) / 3
